  ...
  return (
   ...
   className="min-h-screen bg-cover bg-center flex items-center justify-center"
     ...
     <div className="mt-24 w-11/12 lg:w-10/12">
      ...
      <form className="max-w-3xl bg-transparent backdrop-blur-3xl shadow-sm shadow-black p-10 rounded-lg space-y-5 text-secondary">
        <h2 className="text-center underline text-2xl font-bold text-secondary">Create Group</h2>
        {/* Group Name */}
        <div>
        ...
        {/* Meeting Location */}
        <div>
          <label className="block mb-1 font-semibold" htmlFor="meetingLocation">
