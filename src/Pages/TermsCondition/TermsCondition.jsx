  ...
  return (
    <div data-aos="fade-left" className="w-11/12 xl:w-10/12 2xl:w-8/12 mx-auto px-4 pt-32 pb-20 text-gray-600 dark:text-gray-300 space-y-6">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium text-orange-500 mt-6 mb-2">1. Account Responsibility</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium  text-orange-500 mt-6 mb-2">2. Acceptable Use</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium text-orange-500 mt-6 mb-2">3. Content Ownership</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium text-orange-500 mt-6 mb-2">4. Termination</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium text-orange-500 mt-6 mb-2">5. Privacy Policy</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl: lg:text-2xl font-medium text-orange-500 mt-6 mb-2">6. Changes to Terms</h2>
                <p className="text-lg">
            ...
            <div data-aos="fade-left">
                <h2 className="text-xl lg:text-2xl font-medium text-orange-500 mt-6 mb-2">7. Contact Us</h2>
                <p className="text-lg">
